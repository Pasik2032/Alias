...
func routes(_ app: Application) throws {
  ...
  try app.register(collection: WaitRoomController())
...
//    let id = Int(req.parameters.get("id")!)!
//    let user = try req.jwt.verify(as: Userr.self)
//    let game = Game.find(id: id)
//    if game.admin != Player(user: user) {
//      throw Abort(.badRequest)
//    }
...
//    let payload = try req.jwt.verify(as: Userr.self)
//    print(payload)
//    return .ok
//  }
//
...
//    }
//
//    let userModel = Userr.User.first {
//      $0.login == model.login && $0.password == model.password
//    }
//
//    if let userModel {
